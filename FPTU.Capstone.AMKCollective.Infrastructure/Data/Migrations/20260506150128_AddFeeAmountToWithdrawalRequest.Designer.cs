...
namespace FPTU.Capstone.AMKCollective.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260506150128_AddFeeAmountToWithdrawalRequest")]
    partial class AddFeeAmountToWithdrawalRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.AIChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AIChatConversations", (string)null);
                });

            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.AIChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.Model", b =>
                {
                    ...
                    b.Property<bool>("IsBuilderReady")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("PartType", "IsActive", "IsBuilderReady");
            ...
            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("RevenueRecognizedAt")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("CreatedAt", "OrderStatus", "IsDeleted")
            ...
            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.UserSearchHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("UserId", "Keyword", "SearchType")
                        .IsUnique();
            ...
            modelBuilder.Entity("FPTU.Capstone.AMKCollective.Domain.Entities.AIChatMessage", b =>
                {
                    b.HasOne("FPTU.Capstone.AMKCollective.Domain.Entities.AIChatConversation", "Conversation")
                        .WithMany("Messages")
