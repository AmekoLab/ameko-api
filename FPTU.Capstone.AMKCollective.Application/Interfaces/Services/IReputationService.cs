...
namespace FPTU.Capstone.AMKCollective.Application.Interfaces.Services
{
    ...
    {
        Task<int> AdjustReputationAsync(ReputationTargetType targetType, Guid targetId, int delta, string? reason = null, string? referenceType = null, string? referenceId = null);
        Task<int> AdjustCustomerScoreAsync(Guid userId, int delta, string? reason = null, string? referenceType = null, string? referenceId = null);
        Task<int> AdjustShopScoreAsync(Guid shopId, int delta, string? reason = null, string? referenceType = null, string? referenceId = null);
